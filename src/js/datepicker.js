	...
	!function () {
		var s, a, n, h = "2.2.3", o = "datepicker", r = ".datepicker-here", c = !1,
			...
			l = {
				...
				prevHtml: '<svg><path d="M17 8.01562V9.98438H3.98801L9.56613' +
					' 15.6094L8.15988 17.0156L0.144258 9L8.15988 0.984375L9.56613 2.39062L3.98801 8.01562H16.1755Z"></path></svg>',
		...
		n = m, n.prototype = {
			VERSION: h, viewIndexes: ["days", "months", "years"], init: function () {
				...
				e = e || this.date;
				var i, s = t, a = this._getWordBoundaryRegExp, h = this.loc,
					o = n.getLeadingZeroNum, r = n.getDecade(e), c = n.getParsedDate(e),
					d = c.fullHours, l = c.hours,
					u = t.match(a("aa")) || t.match(a("AA")), m = "am",
					p = this._replacer;
				...
				var e = this, i = e.opts, s = e.parsedDate, a = e.selectedDates,
					h = a.length, o = "";
				...
				var t, e = this, i = e.opts, s = e.loc.dateFormat,
					a = i.altFieldDateFormat, n = e.selectedDates.map(function (t) {
				...
				var i = t.getTime(), s = n.getParsedDate(t),
					a = n.getParsedDate(this.minDate), h = n.getParsedDate(this.maxDate),
				...
				var e, i, s = this._getDimensions(this.$el),
					a = this._getDimensions(this.$datepicker), n = t.split(" "),
				...
				var e, i, s, a = n.getParsedDate(this._getFocusedDate()), h = this.opts,
					o = !1, r = !1, c = !1, d = a.year, l = a.month, u = a.date;
				switch (t) {
					case"ctrlRight":
					case"ctrlUp":
						l += 1, o = !0;
				...
				e = e || this.cellType;
				var i = n.getParsedDate(this._getFocusedDate()), s = i.year,
					a = i.month, h = i.date;
			...
			if (!t || !e) return !1;
			var s = n.getParsedDate(t), a = n.getParsedDate(e), h = i ? i : "day",
				o = {
		...
		s.Body = function (t, i, s) {
			...
			init: function () {
				...
				var i = "datepicker--cell datepicker--cell-" + e, s = new Date,
					n = this.d, h = a.resetTime(n.minRange), o = a.resetTime(n.maxRange),
					r = n.opts, c = a.getParsedDate(t), d = {}, l = c.date;
				switch (e) {
					case"day":
				...
				var e = a.getDaysCount(t),
					...
					n = i - this.d.loc.firstDay, h = 6 - s + this.d.loc.firstDay;
				...
				var e = (a.getParsedDate(t), a.getDecade(t)), i = e[0] - 1, s = "",
					n = i;
